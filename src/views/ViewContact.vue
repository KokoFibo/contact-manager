<template>
  <div class="container mt-3">
    <div class="row">
      <div class="col">
        ...
        <p class="fst-italic">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati alias necessitatibus at et dignissimos? Amet dolorum vel, reprehenderit ullam culpa, tempore necessitatibus aperiam reiciendis magni, ratione rem voluptatum
          incidunt distinctio?
        </p>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-4">
        <img src="https://cdn-icons-png.flaticon.com/512/219/219986.png" class="contact-img-big" />
      </div>
      <div class="col-md-6">
        <ul class="list-group">
